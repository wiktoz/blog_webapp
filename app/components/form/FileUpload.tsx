    ...
    return(
        <div className={"flex flex-col gap-1 text-sm"}>
            ...
            </div>
            {
                ...
                <div className={"flex flex-col gap-2 rounded-lg p-4  shadow bg-[#fffbef]"}>
                            ...
                            files.map((file, idx) => {
                                return (
                                    <Reorder.Item key={file.name + "-" + idx} value={file}
                                                  className={" shadow overflow-hidden flex flex-col rounded-lg"}>
                                        <div className={"flex flex-row items-center justify-between bg-primary p-2 py-4"}>
                    ...
                    <div className={"text-xs px-1 pt-2"}>{files.length} {files.length === 1 ? "image" : "images"}</div>
                </div>
            }
